...
const DB = {
  ...
  // 資料版本（每次重大更新設施資料時遞增）
  VERSION: '5.12',  // 匯入113年(2024-07-03)全面檢測4份工程PDF，新增16筆professional_structure
  ...
  init() {
    const data = {
      ...
      inspections: [
        ...
        { id: 9024, facilityId: 16, facilityName: '橫流溪全段（步道0K+000~1K+290）', formType: 'professional_structure', date: '2024-07-03', inspector: '余建廷、張哲銘', inspectUnit: '林業及自然保育署臺中分署', inspectNo: '橫流溪－113－步道護欄－31', position: '横流溪上游親水區', structType: '護岸護欄 南洋櫸木鍍鋅鋼板', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級 例行維護（不定期檢測）', findings: 'A型護岸護欄(L=95.5m, H=1.2m)、B型(L=9.0m, H=1.3m)、C型(L=18.0m, H=1.2m)、D型(L=8.5m, H=1.2m)，南洋櫸木鍍鋅鋼板，外觀良好，無明顯腐朽或鬆脫。', action: '例行維護（不定期檢測）', appearanceOther: '', status: '完成', priority: '低', weather: '晴', sourcePdf: '31_仙區23林班治理工程.pdf', photos: [] },
        { id: 9025, facilityId: 15, facilityName: '護岸', formType: 'professional_structure', date: '2024-07-03', inspector: '余建廷、張哲銘', inspectUnit: '林業及自然保育署臺中分署', inspectNo: '橫流溪－113－護岸－31', position: '横流溪上游親水區', structType: '擋土牆護坡 鋼筋混凝土砌石', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級 例行維護（定期檢測）', findings: '擋土牆護坡工程(L=95.5m, H=1.6m, RC)、乾砌石擋土牆(L=77m)、階段式砌石擋土牆漸變(L=45m)、B型擋土牆(L=20m, RC)、階段式砌石擋土牆(L=132m, H=1.5m)，外觀良好，功能健全。', action: '例行維護（定期檢測）', appearanceOther: '', status: '完成', priority: '低', weather: '晴', sourcePdf: '31_仙區23林班治理工程.pdf', photos: [] },
      ],
      settings: {
        lastUpdate: new Date().toISOString(),
        version: this.VERSION,
