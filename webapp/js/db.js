...
const DB = {
  ...
  // 資料版本（每次重大更新設施資料時遞增）
  VERSION: '5.24',  // 匯入115年構造物調查表28筆（宜順工程顧問，115.7.18~7.19）  // 強制重新正規化巡查紀錄：套用sf_grade誤植自癒＋風險分級統一，修正舊快取顯示A1但實際為B/C級的問題
  ...
  init() {
    const data = {
      ...
      inspections: [
        ...
        { id: 8101, facilityId: 13, facilityName: '溪構1-1 粗石斜曲面式魚道', formType: 'professional_structure', inspector: '林志勇', inspectUnit: '裡冷溪及橫流溪整體治理規劃與監測調查', date: '2016-05-24', weather: '', status: '完成', priority: '低', appearanceOther: '', sourcePdf: '頁面擷取自-裡冷溪及橫流溪整體治理規劃與監測調查-105年構造物巡檢.pdf', inspectNo: '橫流溪－105－溪構1-1', position: '横流溪', structType: '粗石斜曲面式魚道 混凝土砌塊石', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級（A2）進入不定期檢測系統', findings: '105年構造物檢測（橫流溪野溪下游整治工程）：粗石斜曲面式魚道外觀良好、功能健全（A2級）。', action: 'A2：進入不定期檢測系統', photos: ['/webapp/assets/report-photos/inspect105/xigou1-1_2016.jpg'] },
        { id: 8102, facilityId: 14, facilityName: '溪構1-2 改良型舟通式魚道', formType: 'professional_structure', inspector: '林志勇', inspectUnit: '裡冷溪及橫流溪整體治理規劃與監測調查', date: '2016-05-24', weather: '', status: '完成', priority: '低', appearanceOther: '', sourcePdf: '頁面擷取自-裡冷溪及橫流溪整體治理規劃與監測調查-105年構造物巡檢.pdf', inspectNo: '橫流溪－105－溪構1-2', position: '横流溪', structType: '改良式舟通式魚道 混凝土', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級（A2）進入不定期檢測系統', findings: '105年構造物檢測（橫流溪野溪下游整治工程）：改良式舟通式魚道外觀良好、功能健全（A2級）。', action: 'A2：進入不定期檢測系統', photos: ['/webapp/assets/report-photos/inspect105/xigou1-2_2016.jpg'] },
        { id: 8103, facilityId: 11, facilityName: '溪構9 固床工', formType: 'professional_structure', inspector: '林志勇', inspectUnit: '裡冷溪及橫流溪整體治理規劃與監測調查', date: '2016-05-24', weather: '', status: '完成', priority: '低', appearanceOther: '', sourcePdf: '頁面擷取自-裡冷溪及橫流溪整體治理規劃與監測調查-105年構造物巡檢.pdf', inspectNo: '橫流溪－105－溪構9', position: '横流溪', structType: '固床工（1號固床工）混凝土', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級（A2）進入不定期檢測系統', findings: '105年構造物檢測（橫流溪野溪下游整治工程）：1號固床工外觀良好、功能健全（A2級）。〔對應推定：1號固床工→溪構9，依固床工數量(3座)與由上游至下游序位推定〕', action: 'A2：進入不定期檢測系統', photos: [] },
        { id: 8104, facilityId: 8, facilityName: '溪構10 固床工', formType: 'professional_structure', inspector: '林志勇', inspectUnit: '裡冷溪及橫流溪整體治理規劃與監測調查', date: '2016-05-24', weather: '', status: '完成', priority: '低', appearanceOther: '', sourcePdf: '頁面擷取自-裡冷溪及橫流溪整體治理規劃與監測調查-105年構造物巡檢.pdf', inspectNo: '橫流溪－105－溪構10', position: '横流溪', structType: '固床工（2號固床工）混凝土', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級（A2）進入不定期檢測系統', findings: '105年構造物檢測（橫流溪野溪下游整治工程）：2號固床工外觀良好、功能健全（A2級）。另既設#2固床工修補1處亦檢測良好。〔對應推定：2號固床工→溪構10〕', action: 'A2：進入不定期檢測系統', photos: [] },
        { id: 8105, facilityId: 3, facilityName: '溪構11 階梯式固床工', formType: 'professional_structure', inspector: '林志勇', inspectUnit: '裡冷溪及橫流溪整體治理規劃與監測調查', date: '2016-05-24', weather: '', status: '完成', priority: '低', appearanceOther: '', sourcePdf: '頁面擷取自-裡冷溪及橫流溪整體治理規劃與監測調查-105年構造物巡檢.pdf', inspectNo: '橫流溪－105－溪構11', position: '横流溪', structType: '固床工（3號固床工）混凝土', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級（A2）進入不定期檢測系統', findings: '105年構造物檢測（橫流溪野溪下游整治工程）：3號固床工外觀良好、功能健全（A2級）。〔對應推定：3號固床工→溪構11〕', action: 'A2：進入不定期檢測系統', photos: ['/webapp/assets/report-photos/inspect105/xigou11_2016.jpg'] },
        ...
        { id: 8107, facilityId: 2, facilityName: '溪構8-1 防砂壩', formType: 'professional_structure', inspector: '林志勇', inspectUnit: '裡冷溪及橫流溪整體治理規劃與監測調查', date: '2016-05-24', weather: '', status: '完成', priority: '低', appearanceOther: '', sourcePdf: '頁面擷取自-裡冷溪及橫流溪整體治理規劃與監測調查-105年構造物巡檢.pdf', inspectNo: '橫流溪－105－溪構8-1', position: '横流溪', structType: '防砂壩 混凝土', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級（A2）進入不定期檢測系統', findings: '105年構造物檢測（橫流溪野溪整治第三期工程）：防砂壩外觀良好、功能健全（A2級）。〔對應推定：第三期防砂壩→溪構8-1〕', action: 'A2：進入不定期檢測系統', photos: [] },
        { id: 8108, facilityId: 15, facilityName: '護岸', formType: 'professional_structure', inspector: '林志勇', inspectUnit: '裡冷溪及橫流溪整體治理規劃與監測調查', date: '2016-05-24', weather: '', status: '完成', priority: '低', appearanceOther: '', sourcePdf: '頁面擷取自-裡冷溪及橫流溪整體治理規劃與監測調查-105年構造物巡檢.pdf', inspectNo: '橫流溪－105－護岸', position: '横流溪', structType: '護岸／護坡類（漿砌石‧乾砌石‧重力式‧半重力式‧混凝土砌塊石‧護岸加高‧木排樁護坡‧槽框保護工）', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級（A2）進入不定期檢測系統', findings: '105年構造物檢測：橫流溪各期整治工程之護岸／護坡類構造物均外觀良好、功能健全（A2級）。含漿砌石護坡、木排樁護坡（野溪整治工程）；重力式護岸、混凝土砌塊石護岸、既有護岸加高、乾砌石護坡（第二期）；乾砌石護坡、混砌石護岸（第三期）；半重力式護岸、槽框保護工（下游整治工程）。', action: 'A2：進入不定期檢測系統', photos: ['/webapp/assets/report-photos/inspect105/hugan_2016.jpg'] },
