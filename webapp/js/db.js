...
const DB = {
  ...
  // 資料版本（每次重大更新設施資料時遞增）
  VERSION: '5.14',  // 113年全面檢測11筆補上竣工報告現況照(工項對應裁切)＋遷移回填既有記錄照片：溪構1-1/1-2/6/8-2/11、護岸、步道護欄、擋土牆
  ...
  init() {
    const data = {
      ...
      inspections: [
        ...
        { id: 9013, facilityId: 11, facilityName: '溪構9 固床工', formType: 'professional_structure', date: '2024-07-03', inspector: '余建廷、張哲銘', inspectUnit: '林業及自然保育署臺中分署', inspectNo: '橫流溪－113－溪構9－13', position: '横流溪下游段', structType: '固床工 混凝土', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級 例行維護（定期檢測）', findings: '#1固床工(L=27.54m, H=1.7m)，外觀狀況良好，功能健全。', action: '例行維護（定期檢測）', appearanceOther: '', status: '完成', priority: '低', weather: '晴', sourcePdf: '13_橫流溪野溪下游整治工程.pdf', photos: [] },
        { id: 9014, facilityId: 8, facilityName: '溪構10 固床工', formType: 'professional_structure', date: '2024-07-03', inspector: '余建廷、張哲銘', inspectUnit: '林業及自然保育署臺中分署', inspectNo: '橫流溪－113－溪構10－13', position: '横流溪下游段', structType: '固床工 混凝土', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級 例行維護（定期檢測）', findings: '#2固床工(L=23.58m, H=1.7m)，外觀狀況良好，功能健全。', action: '例行維護（定期檢測）', appearanceOther: '', status: '完成', priority: '低', weather: '晴', sourcePdf: '13_橫流溪野溪下游整治工程.pdf', photos: [] },
        ...
        { id: 9020, facilityId: 3, facilityName: '溪構11 階梯式固床工', formType: 'professional_structure', date: '2024-07-03', inspector: '余建廷、張哲銘', inspectUnit: '林業及自然保育署臺中分署', inspectNo: '橫流溪－113－溪構11－71', position: '横流溪上游段', structType: '階梯式固床工 漿砌石', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級 例行維護（定期檢測）', findings: '階梯式固床工(L=10.5m, W=39.0m, 漿砌石)，外觀狀況良好，功能健全，無裂縫或淘空情形。', action: '例行維護（定期檢測）', appearanceOther: '', status: '完成', priority: '低', weather: '晴', sourcePdf: '71_橫流溪下游段改善工程.pdf', photos: [] },
        ...
        { id: 9022, facilityId: 19, facilityName: '平臺3', formType: 'professional_structure', date: '2024-07-03', inspector: '余建廷、張哲銘', inspectUnit: '林業及自然保育署臺中分署', inspectNo: '橫流溪－113－平臺3－31', position: '横流溪上游親水區', structType: '景觀平台 南洋櫸木H型鋼鍍鋅方管', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級 例行維護（定期檢測）', findings: '景觀平台(L=60m, W=40.5m, 南洋櫸木H型鋼鍍鋅方管)，外觀狀況良好，功能健全，木材無明顯腐朽，鋼構無鏽蝕。', action: '例行維護（定期檢測）', appearanceOther: '', status: '完成', priority: '低', weather: '晴', sourcePdf: '31_仙區23林班治理工程.pdf', photos: [] },
        { id: 9023, facilityId: 20, facilityName: '平臺4', formType: 'professional_structure', date: '2024-07-03', inspector: '余建廷、張哲銘', inspectUnit: '林業及自然保育署臺中分署', inspectNo: '橫流溪－113－平臺4－31', position: '横流溪上游親水區', structType: '景觀平台 南洋櫸木H型鋼鍍鋅方管', level: 'A級', icLevel: null, deru_d: 0, deru_e: 1, deru_r: 1, deru_u: 1, deru_label: 'A級 例行維護（定期檢測）', findings: '景觀平台(L=60m, W=40.5m, 南洋櫸木H型鋼鍍鋅方管)，外觀狀況良好，功能健全，木材無明顯腐朽，鋼構無鏽蝕。', action: '例行維護（定期檢測）', appearanceOther: '', status: '完成', priority: '低', weather: '晴', sourcePdf: '31_仙區23林班治理工程.pdf', photos: [] },
