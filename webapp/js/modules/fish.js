...
/* ── 河道土砂淤積量（唯一量化來源）──
   來源：107~108年度橫流溪整治規劃設計監造與監測調查委託技術服務案 成果報告
         5-4 河道土砂生產量估算、表 5-14（列印頁 144 / PDF 頁 160）
   方法：以 5x5m 網格數值高程模型，比對 97 年與 107 年航照影像所產製之高程
         與河寬差量，每 200m 一樁位累計淤積量。

   ★ 這是「河道內既有淤積量」，不是「防砂壩的計畫攔砂量」。
     兩者不可互換：前者為實測的河道土砂存量，後者為設計時的容量上限。
     全報告 251 頁未載任一防砂壩之計畫攔砂量／貯砂量，平台亦不得代算。

   ⚠ 資料界線：表 5-14 表頭印為「腦寮溪(樁號)」，但「腦寮溪」三字在全報告
     251 頁中僅此一處，而「橫流溪」出現於 83 頁，且該表前後內文均稱「本計畫
     區」。研判為表頭沿用他案模板未修正，惟原文如此，故原樣保留並標示存疑，
     不逕自更名為橫流溪。引用前宜向原顧問確認。

   驗算：兩年度分項合計與原文所載總量一致（226,534 / 138,083），差額 88,451。
   原文 97 年 0K+400 印為「6,8837」，經合計反推應為 68,837，屬印刷逗號誤植。 */
const HLX_SEDIMENT_CHANNEL = {
  source: '107~108年度橫流溪整治規劃設計監造與監測調查委託技術服務案 成果報告 表5-14（頁144）',
  method: '5x5m DEM 網格，97 年與 107 年航照高程及河寬差量比對，每 200m 一樁位',
  headerNote: '原表表頭印為「腦寮溪(樁號)」，研判為他案模板未修正；原文保留，引用前宜確認',
  unit: 'm³',
  rows: [
    { station: '0K+000', area97:  32.03, vol97:  null, area107:  18.49, vol107:  null },
    { station: '0K+200', area97:  31.94, vol97:  6397, area107:  21.46, vol107:  3995 },
    //  原文印為「6,8837」，由分項合計反推應為 68,837
    { station: '0K+400', area97: 656.43, vol97: 68837, area107: 461.12, vol107: 48258 },
    { station: '0K+600', area97: 125.13, vol97: 78156, area107:  50.95, vol107: 51207 },
    { station: '0K+800', area97:  53.03, vol97: 17816, area107:  26.38, vol107:  7733 },
    { station: '1K+000', area97:  18.77, vol97:  7180, area107:  18.07, vol107:  4445 },
    { station: '1K+200', area97: 195.98, vol97: 21475, area107:  88.22, vol107: 10629 },
    { station: '1K+400', area97:  70.75, vol97: 26673, area107:  29.94, vol107: 11816 },
  ],
  total97: 226534,
  total107: 138083,
  //  97→107 年河道淤積量減少 88,451 m³
  decrease: 88451,
};
