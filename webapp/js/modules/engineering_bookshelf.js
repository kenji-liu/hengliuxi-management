...
const ENGINEERING_BOOKS = [
  ...
  },
  {
    ...
    //  原簡介寫「於橫流溪佈設20點」是錯的：全份報告未出現「橫流溪」三字
    //  （實測 0 次），20 台是溪流環境相機，架在烏溪、筏子溪、大里溪與旱溪。
    //  橫流溪的石虎紀錄不在這份，而在東勢處野生動物資源報告 P.51（NAA20 樣點）。
    summary: '臺中西部淺山保育軸帶烏溪流域石虎族群監測計畫115年期中報告（研究期：2025年12月–2027年1月）。淺山保育軸帶設40個樣點、溪流環境設20台自動相機，統計石虎OI值並追蹤族群動態。監測範圍為臺中西部淺山、烏溪、筏子溪、大里溪與旱溪，未涵蓋大甲溪流域的橫流溪，屬流域外的生態背景參考。',
